...
// réelles (cf. js/calibrate.mjs et data/calibration-campaigns.mjs). Ne pas
// modifier à la main sans relancer la calibration : les 4 valeurs sont
// interdépendantes (steepness compense midpoint).
...
export function computeRawSignals(profile, analysis) {
  ...
  const urgencySignal = analysis.themes.subject.urgence * 0.09 + analysis.themes.preheader.urgence * 0.05;
